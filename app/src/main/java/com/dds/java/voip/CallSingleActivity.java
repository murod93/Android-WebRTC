...
public class CallSingleActivity extends AppCompatActivity implements CallSession.CallSessionCallback {
    ...
    private CallSession.CallSessionCallback callSessionCallback;
    ...
    private void init(String targetId, boolean outgoing, boolean audioOnly) {
        ...
        callSessionCallback = (CallSession.CallSessionCallback) fragment;
    ...
    public void didChangeState(EnumType.CallState callState) {
        handler.post(() -> callSessionCallback.didChangeState(callState));
    }

    @Override
    public void didChangeMode(boolean var1) {
        handler.post(() -> callSessionCallback.didChangeMode(var1));
    }

    @Override
    public void didCreateLocalVideoTrack() {
        handler.post(() -> callSessionCallback.didCreateLocalVideoTrack());
    }

    @Override
    public void didReceiveRemoteVideoTrack() {
        handler.post(() -> callSessionCallback.didReceiveRemoteVideoTrack());
    }
    ...
    private boolean checkOverlayPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!SettingsCompat.canDrawOverlays(this)) {
                Toast.makeText(this, "Need floating window permissions", Toast.LENGTH_LONG).show();
